          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="example2-listado_fact.php" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="example2-gestionar_fact.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                  <a href="example2-nueva_fact.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Nueva factura</p>
                  </a>
                </li>
                        ...
                        <?php 
                          if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                              ...
                              echo "<form action='example2-gestionar_fact.php' method='post'>";
                              echo "<td><button type='submit' name='delete' value='".$row["id"]."' class='badge badge-danger'>Borrar</button>
                                        <button type='submit' name='edit' value='".$row["id"]."' class='badge badge-warning ml-1'>Editar</button>
                                    </td>";
                              echo "</form>";
                              echo "</tr>";
                            }
